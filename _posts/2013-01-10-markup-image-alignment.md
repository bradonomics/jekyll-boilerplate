...
![image-center]({{ site.url }}{{ site.baseurl }}/images/image-alignment-580x300.jpg){: .aligncenter}

The image above happens to be **centered**.

![image-left]({{ site.url }}{{ site.baseurl }}/images/image-alignment-150x150.jpg){: .alignleft} The rest of this paragraph is filler for the sake of seeing the text wrap around the 150×150 image, which is **left aligned**.
...
![image-right]({{ site.url }}{{ site.baseurl }}/images/image-alignment-300x200.jpg){: .alignright}
